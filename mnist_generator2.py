...
class DCGAN():
    def __init__(self):
        ...
        self.other_rows = 32
        self.other_cols = 32
        self.other_channels = 3
        self.other_shape = (self.other_rows, self.other_cols, self.other_channels)
        ...
        # The generator takes images from cifar10 as input
        z = Input(shape=self.other_shape)
